...
public class PizzaCutter 
{
    ...
    //modify by jjx success to singleton
    private static PizzaCutter cutterObject1=null;
    private PizzaCutter()
    {
        //intentionally left blank
    }
    public static PizzaCutter getCutter(){
        if(cutterObject1==null){
            cutterObject1=new PizzaCutter();
        }
        return cutterObject1;
    }
}
